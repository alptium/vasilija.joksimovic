...
public class Main {
	...
	public static void main(String[] args) {
		...
		try(Scanner sc = new Scanner(System.in)) {
			...
			System.out.printf(studentName1);
			System.out.println("\t");
			System.out.printf(studentSurname1); 
			System.out.println("\t");
			System.out.println("Grade:" + grade1);
			System.out.println("\n");
			
			System.out.printf(studentName2);
			System.out.println("\t");
			System.out.printf(studentSurname2);
			System.out.println("\t");
			System.out.println("Grade:" + grade2); 
			System.out.println("\n");
			
			System.out.printf(studentName3 );
			System.out.println("\t");
			System.out.printf(studentSurname3);
			System.out.println("\t");
			System.out.println("Grade:" + grade3);
			System.out.println("\n");
			
			System.out.printf(studentName4);  
			System.out.println("\t");
			System.out.printf(studentSurname4);
			System.out.println("\t");
			System.out.println("Grade:" + grade4); 
			System.out.println("\n");
			
			System.out.printf(studentName5); 
			System.out.println("\t");
			System.out.printf(studentSurname5);
			System.out.println("\t");
