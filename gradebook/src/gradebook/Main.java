...
public class Main {
	...
	public static void main(String[] args) {
		...
		try(Scanner sc = new Scanner(System.in)) {
			...
			System.out.println("1. " + studentName1 + "\t" + studentSurname1 + "\t" + "Grade: " + grade1);
			System.out.println();
			
			System.out.println("2. " + studentName2 + "\t" + studentSurname2 + "\t" + "Grade: " + grade2);
			System.out.println();
			
			System.out.println("3. " + studentName3 + "\t" + studentSurname3 + "\t" + "Grade: " + grade3);
			System.out.println();
			
			System.out.println("4. " + studentName4 + "\t" + studentSurname4 + "\t" + "Grade: " + grade4);
			System.out.println();
			
			System.out.println("5. " + studentName5 + "\t" + studentSurname5 + "\t" + "Grade: " + grade5);
			System.out.println();
